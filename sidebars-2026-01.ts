		...
		},
		{
			...
			items: [
				"mlops/kubernetes/tools/kustomize",
				{
					type: "category",
					label: "Helm",
					items: ["mlops/kubernetes/tools/helm/helm", "mlops/kubernetes/tools/helm/custom-chart"],
				},
		...
		},
		{
			...
			items: [
				...
				},
				{
					type: "category",
					label: "OpenTelemetry",
					items: ["lang/python/libraries/opentelemetry/trace"],
				},
			],
		},
		{
