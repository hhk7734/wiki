!(function (e, t) {
	...
	return (function () {
			...
			h = (function () {
				function e(e) {
					(this.displayMode = void 0),
						...
						(this.minRuleThickness = Math.max(0, l.deflt(e.minRuleThickness, 0))),
		...
		var x = [];
		function w(e) {
			for (var t = 0; t < x.length; t += 2) if (e >= x[t] && e <= x[t + 1]) return !0;
			return !1;
		}
				...
				return (
					...
					(t.toNode = function () {
						...
						for (var r in (this.italic > 0 &&
							((t = document.createElement('span')).style.marginRight = this.italic + 'em'),
						this.classes.length > 0 &&
							((t = t || document.createElement('span')).className = z(this.classes)),
						this.style))
					...
					(t.toMarkup = function () {
						var e = !1,
							t = '<span';
						this.classes.length &&
							((e = !0), (t += ' class="'), (t += l.escape(z(this.classes))), (t += '"'));
						var r = '';
		...
		function _(e, t, r, n, a, i) {
			(W[e][a] = { font: t, group: r, replace: n }), i && n && (W[e][n] = W[e][a]);
		}
		var j = 'math',
			$ = 'text',
			Z = 'main',
			...
			Ie = (function () {
				...
				return (
					...
					(t.havingStyle = function (e) {
						return this.style === e ? this : this.extend({ style: e, size: Ce(this.textSize, e) });
					}),
		...
		var Re = Ie,
			...
			De = function (e, t, r) {
				return (
					X[r][e] && X[r][e].replace && (e = X[r][e].replace), { value: e, metrics: V(e, t, r) }
				);
			},
			...
			Fe = function (e, t) {
				if (z(e.classes) !== z(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize)
					return !1;
				...
				makeOrd: function (e, t, r) {
					...
					if (l) {
						...
						if ('boldsymbol' === l) {
							...
							s
								? ((u = Xe[l].fontName), (p = [l]))
								: ((u = We(l, t.fontWeight, t.fontShape)), (p = [l, t.fontWeight, t.fontShape]));
			...
			Je = {
				...
				mpunct: { mord: $e, mop: $e, mrel: Ke, mopen: $e, mclose: $e, mpunct: $e, minner: $e },
				minner: { mord: $e, mop: $e, mbin: Ze, mrel: Ke, mopen: $e, mpunct: $e, minner: $e }
			},
			Qe = {
				mord: { mop: $e },
				mop: { mord: $e, mop: $e },
		...
		var it = function (e) {
			...
			pt = function e(t, r, n, a, i) {
				...
				for (var o = 0; o < t.length; o++) {
					...
					if (l) e(l.children, r, n, null, i);
						...
						h ? (n.node = s) : i && s.hasClass('newline') && (n.node = st(['leftmost'])),
			...
			dt = function (e) {
				return e instanceof M || e instanceof N || (e instanceof q && e.hasClass('enclosing'))
					? e
					: null;
			},
			ft = function e(t, r) {
			...
			for (var i, o = [], s = [], l = 0; l < a.length; l++)
				if (
					...
					a[l].hasClass('newline') &&
						(s.pop(), s.length > 0 && (o.push(yt(s, t)), (s = [])), o.push(a[l]));
			s.length > 0 && o.push(yt(s, t)),
				r ? (((i = yt(ut(r, t, !0))).classes = ['tag']), o.push(i)) : n && o.push(n);
		...
		var kt = (function () {
				...
				return (
					...
					(t.toMarkup = function () {
						...
						this.classes.length > 0 && (e += ' class ="' + l.escape(z(this.classes)) + '"'),
							(e += '>');
						for (var r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
						return (e += '</' + this.type + '>');
					}),
		...
		function Ct(e, t, r, n, a) {
			var i,
				o = Bt(e, r);
			i =
				1 === o.length && o[0] instanceof kt && l.contains(['mrow', 'mtable'], o[0].type)
					? o[0]
		...
		var It = function (e) {
			...
			Lt = function (e, t, r, n, a) {
				...
				if (/fbox|color|angl/.test(t)) {
					...
					var l = [];
					/^[bx]cancel$/.test(t) &&
						l.push(new H({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
						/^x?cancel$/.test(t) &&
							l.push(
								new H({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' })
							);
			...
			Pt = function (e, t) {
				var r = (function () {
					...
					i = r.height;
				return (
					(n.height = i), (n.style.height = i + 'em'), a > 0 && (n.style.minWidth = a + 'em'), n
				);
			};
		function Ft(e, t) {
			if (!e || e.type !== t)
						...
						(h = je.makeVList(
							{
								...
								children: [
									{ type: 'elem', elem: i },
									{
										...
										wrapperStyle:
											o > 0
												? { width: 'calc(100% - ' + 2 * o + 'em)', marginLeft: 2 * o + 'em' }
												: void 0
									}
								]
							},
		...
		nt({
			...
			nt({
				...
				props: { numArgs: 1, allowedInText: !0, allowedInMath: !1, argTypes: ['primitive'] },
				handler: function (e, t) {
					var r = t[0];
					return {
						type: 'accent',
			...
			htmlBuilder: function (e, t) {
				...
				i.classes.push(o + '-arrow-pad'),
					e.below &&
						...
						(r = je.wrapFragment(bt(e.below, a, t), t)).classes.push(o + '-arrow-pad'));
				var s,
					l = Pt(e, t),
		...
		nt({
			...
			mathmlBuilder: function (e, t) {
				...
				return (
					...
					(r = new Mt.MathNode('mstyle', [r])).setAttribute('displaystyle', 'false'),
		...
		nt({
			...
			nt({
				...
				htmlBuilder: function (e, t) {
					...
					return (
						e.newLine &&
							(r.classes.push('newline'), e.size && (r.style.marginTop = Le(e.size, t) + 'em')),
						r
					);
				},
				mathmlBuilder: function (e, t) {
		...
		nt({
			...
			handler: function (e) {
				...
				if (Jt[a.text])
					return (
						('\\global' !== r && '\\\\globallong' !== r) || (a.text = Jt[a.text]),
			...
			nt({
				...
				handler: function (e) {
					...
					return (
						...
						t.gullet.macros.set(i, { tokens: h, numArgs: s, delimiters: l }, r === Jt[r]),
				...
				return (
					'small' === i.type
						...
						? ((m = 1080 * gr[i.size]),
						  (h = (gr[i.size] + s) / o),
						  (l = (gr[i.size] + s + cr) / o),
						  ((r = ur('sqrtSize' + i.size, l, m, s, t)).style.minWidth = '1.02em'),
						  (n = 1 / o))
						: ((l = e + s + cr),
						  (h = e + s),
		...
		nt({
			...
			nt({
				...
				htmlBuilder: function (e, t) {
					Cr(e);
					for (
						var r, n, a = ut(e.body, t, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, l = 0;
						l < a.length;
						l++
					)
						a[l].isMiddle
					...
					if (
						((i *= t.sizeMultiplier),
						(o *= t.sizeMultiplier),
						(r = '.' === e.left ? vt(t, ['mopen']) : Tr(e.left, i, o, t, e.mode, ['mopen'])),
						a.unshift(r),
						s)
					)
		...
		var Ir = function (e, t) {
				...
				if ('sout' === o)
					...
					/box/.test(o)
						...
						/fbox|boxed|fcolorbox/.test(o)
							? ((r.style.borderStyle = 'solid'), (r.style.borderWidth = y + 'em'))
							: 'angl' === o &&
							  0.049 !== y &&
							  ((r.style.borderTopWidth = y + 'em'), (r.style.borderRightWidth = y + 'em')),
						(h = i.depth + b),
						e.backgroundColor &&
			...
			Rr = function (e, t) {
				var r = 0,
					n = new Mt.MathNode(e.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [
						Nt(e.body, t)
					]);
				switch (e.label) {
					case '\\cancel':
		...
		var Fr = function (e, t) {
				...
				if (e.addEqnNum)
					for (r = 0; r < i; ++r) {
						...
						(L.depth = E.depth), (L.height = E.height), O.push({ type: 'elem', elem: L, shift: H });
					}
				for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
					...
					if (!(a >= s)) {
						...
						(a > 0 || e.hskipBeforeAndAfter) &&
							...
							(((q = je.makeSpan(['arraycolsep'], [])).style.width = G + 'em'), R.push(q));
						var U = [];
						for (r = 0; r < i; ++r) {
							var Y = h[r],
								W = Y[a];
						...
						(U = je.makeVList({ positionType: 'individualShift', children: U }, t)),
				...
				if (e.addEqnNum) {
					var J = je.makeVList({ positionType: 'individualShift', children: O }, t);
			...
			Gr = function (e, t) {
				for (
					...
					e.addEqnNum && (s.unshift(n), s.push(n), e.leqno ? s.unshift(a) : s.push(a)),
				...
				return (
					...
					'' !== c && (h = new Mt.MathNode('menclose', [h])).setAttribute('notation', c.trim()),
					e.arraystretch &&
						e.arraystretch < 1 &&
						(h = new Mt.MathNode('mstyle', [h])).setAttribute('scriptlevel', '1'),
					h
				);
			},
			Ur = function (e, t) {
		...
		Er({
			...
			Er({
				...
				handler: function (e) {
					...
					return (
						(o.cols = new Array(o.body[0].length).fill({ type: 'align', align: r })),
						t
							? {
									type: 'leftright',
									mode: e.mode,
			...
			Er({
				...
				handler: function (e, t) {
					...
					if ((a = Dr(e.parser, a, 'script')).body.length > 0 && a.body[0].length > 1)
		...
		function _r(e, t) {
			...
			return 'minner' === e.mclass
				...
				: ('mord' === e.mclass
						...
						: (e.isCharacterBox ? ((r = n[0]).type = 'mo') : (r = new Mt.MathNode('mo', n)),
						  'mbin' === e.mclass
		...
		var Jr = function (e, t) {
			...
			Qr = function (e, t) {
				...
				if (
					(e.hasBarLine
						? (e.barSize
								? ((m = Le(e.barSize, t)), (h = je.makeLineSpan('frac-line', t, m)))
					...
					u - o.depth - (w + 0.5 * m) < p && (u += p - (u - o.depth - (w + 0.5 * m))),
						w - 0.5 * m - (x.height - d) < p && (d += p - (w - 0.5 * m - (x.height - d)));
					var k = -(w - 0.5 * m);
					f = je.makeVList(
						{
							positionType: 'individualShift',
				...
				return (
					...
					je.makeSpan(['mord'].concat(r.sizingClasses(t)), [v, je.makeSpan(['mfrac'], [f]), y], t)
				);
			},
			en = function (e, t) {
		...
		nt({
			...
			mathmlBuilder: function (e, t) {
				var r = Dt(e.label);
				return new Mt.MathNode(e.isOver ? 'mover' : 'munder', [Nt(e.base, t), r]);
			}
		}),
			nt({
				type: 'href',
			...
			nt({
				...
				handler: function (e, t) {
					return { type: 'htmlmathml', mode: e.parser.mode, html: ot(t[0]), mathml: ot(t[1]) };
				},
				htmlBuilder: function (e, t) {
					var r = ut(e.html, t, !1);
					return je.makeFragment(r);
		...
		nt({
			...
			nt({
				...
				htmlBuilder: function (e, t) {
					var r;
					'clap' === e.alignment
						? ((r = je.makeSpan([], [bt(e.body, t)])), (r = je.makeSpan(['inner'], [r], t)))
		...
		var sn = function (e, t, r, n, a, i, o) {
			...
			hn = function (e, t) {
				...
				var o,
					...
					h = !1;
				if (
					(s.size === b.DISPLAY.size && a.symbol && !l.contains(ln, a.name) && (h = !0), a.symbol)
				) {
				...
				return (
					...
					i
						? sn(o, r, n, t, s, y, v)
						: (v && ((o.style.position = 'relative'), (o.style.top = v + 'em')), o)
				);
			},
			mn = function (e, t) {
				var r;
		...
		fn('\\char', function (e) {
			...
			if (t) {
				...
				for (var i; null != (i = gn[e.future().text]) && i < t; ) (a *= t), (a += i), e.popToken();
			}
			return '\\@char{' + a + '}';
		});
		...
		fn('\\newcommand', function (e) {
			...
			fn('\\copyright', '\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}'),
			fn('\\textregistered', '\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}'),
			fn('\u212c', '\\mathscr{B}'),
			fn('\u2130', '\\mathscr{E}'),
			fn('\u2131', '\\mathscr{F}'),
			fn('\u210b', '\\mathscr{H}'),
			...
			fn('\u2259', '\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`\u2258}}'),
			fn('\u225a', '\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`\u225a}}'),
			fn('\u225b', '\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`\u225b}}'),
			fn('\u225d', '\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`\u225d}}'),
			fn('\u225e', '\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`\u225e}}'),
			fn('\u225f', '\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`\u225f}}'),
			fn('\u27c2', '\\perp'),
		...
		fn('\\dotso', function (e) {
			...
			fn('\\pod', '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)'),
			fn('\\pmod', '\\pod{{\\rm mod}\\mkern6mu#1}'),
			fn(
				'\\mod',
				'\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1'
			),
			fn('\\pmb', '\\html@mathml{\\@binrel{#1}{\\mathrlap{#1}\\kern0.5px#1}}{\\mathbf{#1}}'),
			fn('\\newline', '\\\\\\relax'),
			fn(
				'\\TeX',
		...
		fn(
			...
			fn('\\simcoloncolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
			fn('\\approxcolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
			fn('\\approxcoloncolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
			fn('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
			...
			fn('\\llbracket', '\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`\u27e6}}'),
			fn('\\rrbracket', '\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`\u27e7}}'),
			fn('\u27e6', '\\llbracket'),
			fn('\u27e7', '\\rrbracket'),
			fn('\\lBrace', '\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`\u2983}}'),
			fn('\\rBrace', '\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`\u2984}}'),
			fn('\u2983', '\\lBrace'),
			fn('\u2984', '\\rBrace'),
			fn(
				'\\minuso',
		...
		var wn = function (e, t) {
			...
			if (
				('supsub' === e.type
					? ((r = e.sup), (n = e.sub), (a = Ft(e.base, 'operatorname')), (o = !0))
					: (a = Ft(e, 'operatorname')),
				a.body.length > 0)
			) {
				for (
				...
				mathmlBuilder: function (e, t) {
					...
					return (
						a >= 0
							...
							: (s.setAttribute('height', a + 'em'), s.setAttribute('depth', '+' + -a + 'em')),
		...
		nt({
			...
			handler: function (e, t) {
				...
				return { type: 'sizing', mode: a.mode, size: Sn.indexOf(n) + 1, body: i };
			},
			htmlBuilder: function (e, t) {
		...
		var Mn = { display: b.DISPLAY, text: b.TEXT, script: b.SCRIPT, scriptscript: b.SCRIPTSCRIPT };
		nt({
			type: 'styling',
		...
		var zn = function (e, t) {
			...
			return r
				? 'op' === r.type
					? r.limits && (t.style.size === b.DISPLAY.size || r.alwaysHandleSupSub)
						? hn
						: null
					: 'operatorname' === r.type
					? r.alwaysHandleSupSub && (t.style.size === b.DISPLAY.size || r.limits)
						? wn
						: null
					: 'accent' === r.type
		...
		at({
			...
			mathmlBuilder: function (e, t) {
				...
				if ((e.sub && i.push(Nt(e.sub, t)), e.sup && i.push(Nt(e.sup, t)), n))
					...
					var l = e.base;
					a =
						(l && 'op' === l.type && l.limits && (t.style === b.DISPLAY || l.alwaysHandleSupSub)) ||
						(l &&
							'operatorname' === l.type &&
		...
		at({
			...
			htmlBuilder: function (e, t) {
				...
				if (Tn.hasOwnProperty(e.text)) return je.makeSpan(['mspace', Tn[e.text]], [], t);
		...
		nt({
			...
			nt({
				...
				htmlBuilder: function (e, t) {
					for (var r = On(e), n = [], a = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
						var o = r[i];
						'~' === o && (o = '\\textasciitilde'),
							n.push(je.makeSymbol(o, 'Typewriter-Regular', e.mode, a, ['mord', 'texttt']));
					}
			...
			Fn = (function () {
				...
				return (
					...
					(t.endGroup = function () {
						...
						for (var t in e)
							e.hasOwnProperty(t) &&
								(void 0 === e[t] ? delete this.current[t] : (this.current[t] = e[t]));
					}),
					(t.has = function (e) {
			...
			Gn = (function () {
				...
				return (
					...
					(t.scanArgument = function (e) {
						...
						return this.pushToken(new Ln('EOF', r.loc)), this.pushTokens(n), t.range(r, '');
					}),
					...
					(t._getExpansion = function (e) {
						...
						if ('string' == typeof n) {
							...
							for (var o = new Pn(n, this.settings), s = [], l = o.lex(); 'EOF' !== l.text; )
								s.push(l), (l = o.lex());
					...
					(t.parseSymbol = function () {
						...
						if (
							...
							this.settings.strict &&
								...
								(i = { type: 'textord', mode: 'text', loc: Hn.range(e), text: t });
						}
						if ((this.consume(), o))
		...
		var jn = function (e, t, r) {
			...
			Zn = {
				...
				__defineSymbol: _,
				__defineMacro: fn,
				__domTree: { Span: q, Anchor: N, SymbolNode: R, SvgNode: O, PathNode: E, LineNode: H }
			};
		return (t = t.default);
	})();
});
