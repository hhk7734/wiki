!(function (e, t) {
	if ('object' == typeof exports && 'object' == typeof module) module.exports = t(require('katex'));
	...
	return (function () {
		...
		return (
			...
			(a = Array.prototype.slice.call(a)).forEach(function (e) {
				...
				try {
					i().render(e.text, r, { displayMode: t });
				} catch (t) {
