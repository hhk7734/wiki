...
<center>
	<figure>
		<DrwaIOViewer src={useBaseUrl("img/mlops/nn/llm/parallelism/micro-batch-pipeline-parallelism.drawio")} />
		<figcaption>
...
<center>
	<img className="bg-white" src={useBaseUrl("img/mlops/nn/llm/parallelism/3d-parallelism-1.png")} />
	<figcaption>
	...
	<img className="bg-white" src={useBaseUrl("img/mlops/nn/llm/parallelism/3d-parallelism-2.png")} />
	<figcaption>
