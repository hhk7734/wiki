...
description: "Beyond the Buzz 2506 - A Pragmatic Take on Inference Disaggregation documents overview material for Pragmatic Disaggregation in the science domain. It is classified as an entity page for the model-family class, so readers can understand its topic, scope, and place in the wiki taxonomy. The page highlights Introduction, Background, Design space exploration, Model partitioning, and Scaling and rate matching, with examples, commands, diagrams, or references kept close to the relevant explanation. Important search terms include neural network, large language model, prefill/decode disaggregation, beyond the buzz 2506 - a pragmatic take on inference disaggregation, and pragmatic-disaggregation, helping both humans and generated indexes connect this page with adjacent concepts."
keywords:
  - "neural network"
  - "large language model"
  - "prefill/decode disaggregation"
  - "pragmatic disaggregation"
...
ontology:
  ...
  domain: science
  class: model-family
  instance: pragmatic-disaggregation
  aspect: overview
subject:
  canonical_name: "Pragmatic Disaggregation"
  aliases: []
relations:
  related_to: []
  depends_on: []
...
- [Beyond the Buzz: A Pragmatic Take on Inference Disaggregation](https://www.arxiv.org/abs/2506.05508)
...
<figure>
	<center>
		<img src={require("./co-located-vs-dissaggregation.png").default} />
		<br />
		<figcaption>
...
<figure>
	<center>
		<img src={require("./scaling-and-rate-matching.png").default} />
		<br />
		<figcaption>
...
$$
\text{Prefill Throughput (requests/s/GPU)} = \dfrac{\text{Batch size}}{\text{FTL} \times \text{Number of GPUs}}
$$

$$
\text{Decode Throughput (tokens/s/GPU)} = \dfrac{\text{Batch size}}{\text{TTL} \times \text{Number of GPUs}}
$$
...
- [NVIDIA Triton Inference Server / Perf benchmarking / GenAI Perf](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/perf_benchmark/genai_perf.html)

:::

<figure>
	<center>
		<img src={require("./pp-ftl-diagram.png").default} />
		<br />
		<figcaption>
...
$$
\text{Interactivity} (\text{tokens/s/user}) = \dfrac{1}{\text{TTL}}
$$

$$
\text{Throughput} (\text{tokens/s/GPU}) = \dfrac{\text{Total output tokens}}{\text{Benchmark duration} \times \text{Number of GPUs}}
$$
...
<figure>
	<center>
		<img src={require("./traffic-sensitivity.png").default} />
		<br />
		<figcaption>
			[Figure 8: Disaggregation helps most under prefill-heavy traffic](https://www.arxiv.org/html/2506.05508)
		</figcaption>
	</center>
</figure>
...
<figure>
	<center>
		<img src={require("./optimal-ratio-of-prefill-to-decode.png").default} />
		<br />
		<figcaption>
