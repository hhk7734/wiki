...
<center>
  <img src={useBaseUrl("mcu/avr/atmel-add-programmer.png")} />
</center>

STK500을 선택한 후, 장치 관리자에서 포트를 확인하여 STK500에 맞는 포트를 선택합니다.

<center>
  <img src={useBaseUrl("mcu/avr/atmel-stk500-setup.png")} />
</center>
...
<center>
  <img src={useBaseUrl("mcu/avr/atmel-register-external-tools.png")} />
</center>
...
<center>
  <img src={useBaseUrl("mcu/avr/atmel-device-programming.png")} />
</center>
...
<center>
  <img src={useBaseUrl("mcu/avr/atmel-external-arguments.png")} />
</center>
...
<center>
  <img src={useBaseUrl("mcu/avr/atmel-custom-tool.png")} />
</center>
