...
- [`resource` -> `outputs.parameters`](/docs/mlops/workflow/argo-workflows/variables.mdx#resource---outputsparameters)
...
- [Argo Workflows DAG template](/docs/mlops/workflow/argo-workflows/dag.mdx)
