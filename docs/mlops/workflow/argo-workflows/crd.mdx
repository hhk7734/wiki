...
- [Argo Workflows entrypoint and templates](/docs/mlops/workflow/argo-workflows/entrypoint-templates.mdx)

### Variables

- [Argo Workflows Variables](/docs/mlops/workflow/argo-workflows/variables.mdx)

### `podGC`

- [podGC](/docs/mlops/workflow/argo-workflows/garbage-collection.mdx#podgc)

### `ttlStrategy`

- [ttlStrategy](/docs/mlops/workflow/argo-workflows/garbage-collection.mdx#ttlstrategy)
