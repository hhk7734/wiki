...
- `affinity: {}`
  - [Affinity](/docs/operation/mlops/orchestrator/scheduling/affinity.mdx)
- `tolerations: []`
  - [Taints and Tolerations](/docs/operation/mlops/orchestrator/scheduling/taint-toleration.mdx)
