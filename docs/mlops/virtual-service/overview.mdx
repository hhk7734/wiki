...
ontology:
  ...
  domain: mlops
  class: service-mesh
  instance: virtual-service
  aspect: overview
subject:
  canonical_name: VirtualService
  aliases: []
relations:
  related_to: []
  depends_on: []
...
- [Cross-Origin Resource Sharing(CORS)](/docs/specification/protocol/application-protocol/http/cors.mdx)
