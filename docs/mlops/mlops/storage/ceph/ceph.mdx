...
Ceph Storage Cluster는 네트워크를 통해 Ceph Block Device, Ceph File System, Ceph Object Storage 등의 서비스를 제공하는
...
- https://docs.ceph.com/en/quincy/start/hardware-recommendations/#cpu
...
- OSD
  ...
  - 스토리지 드라이브
    - 드라이브 1 개당 OSD 1 개
    - OSD에 사용할 드라이브는 다른 프로세스에 의해 사용되지 않는 것을 권장합니다.
- MDS
  - CPU
    - 최소 2 코어
    - 단일 스레드로 동작하며 CPU 집약적이므로 CPU 클럭이 높은 CPU에서 잘 동작합니다.
