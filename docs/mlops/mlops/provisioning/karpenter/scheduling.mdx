...
- https://karpenter.sh/v0.28.0/concepts/scheduling/#well-known-labels
...
- [Topology Spread Constraints](/docs/mlops/mlops/kubernetes/scheduling/topology-spread-constraints)
...
- `topologyKey`
  ...
  - `karpenter.sh/capacity-type`
    ...
    - https://karpenter.sh/v0.28.0/concepts/scheduling/#on-demandspot-ratio-split
