...
- https://karpenter.sh/v0.28.0/concepts/provisioners/
...
- https://karpenter.sh/v0.28.0/concepts/provisioners/#speckubeletconfiguration
...
- https://karpenter.sh/v0.28.0/concepts/provisioners/#specrequirements
...
- https://karpenter.sh/v0.28.0/concepts/node-templates/
