...
- `containers`
  - `args`
    - [Kserve Args](/docs/mlops/mlops/kubeflow/kserve/custom.mdx#kserve-args)
...
:::warning
`predictor.affinity`, `predictor.tolerations` 등의 설정은 [Knative Serving](/docs/mlops/provisioning/knative/knative.mdx#knativeserving)의 설정에서 이를 허용해야 사용할 수 있습니다.
:::
