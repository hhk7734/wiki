...
- [Istio CSR](/docs/mlops/mlops/network/istio/istio-csr)
- [Multi Cluster](/docs/mlops/mlops/network/istio/multi-cluster)
...
```shell
helm template istiod-1-19-3 istio/istiod \
    --version 1.19.3 \
    -n istio-system \
...
```shell
helm upgrade istiod-1-19-3 istio/istiod \
    --install \
    --version 1.19.3 \
    -n istio-system \
    --history-max 3 \
...
<center>
	<img src={useBaseUrl("img/mlops/mlops/mlops-istio-service-mesh-before.svg")} />
</center>
...
<center>
	<img src={useBaseUrl("img/mlops/mlops/mlops-istio-service-mesh.svg")} />
</center>
...
| --------- | ------------------- | ------------------------------- |
| Namespace | istio.io/rev=1-19-3 | istio-injection=disabled        |
| Pod       | istio.io/rev=1-19-3 | sidecar.istio.io/inject="false" |
