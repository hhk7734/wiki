...
```shell
helm template istiod-1-18-2 istio/istiod \
    --version 1.18.2 \
    -n istio-system \
...
```shell
helm upgrade istiod-1-18-2 istio/istiod \
    --install \
    --version 1.18.2 \
    -n istio-system \
    --history-max 3 \
...
| --------- | ------------------- | ------------------------------- |
| Namespace | istio.io/rev=1-18-2 | istio-injection=disabled        |
| Pod       | istio.io/rev=1-18-2 | sidecar.istio.io/inject="false" |
