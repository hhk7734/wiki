...
app.kubernetes.io/name: {{ include "project.fullname" . }}-frontend
app.kubernetes.io/version: {{ default "latest" .Values.frontend.image.tag | quote }}
app: {{ include "project.fullname" . }}-frontend
version: {{ default "latest" .Values.frontend.image.tag | quote }}
{{- end }}
```
