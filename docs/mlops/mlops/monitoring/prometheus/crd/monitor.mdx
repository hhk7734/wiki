...
[kubernetes_sd_configs](#kubernetes_sd_configs)가 자동으로 추가됩니다.
...
- node
  - `__meta_kubernetes_node_name: <nodeName>`
  - `__meta_kubernetes_node_provider_id: <providerName>`
  - `__meta_kubernetes_node_label_<key>: <value>`
  - `__meta_kubernetes_node_labelpresent_<key>: <bool>`
  - `__meta_kubernetes_node_annotation_<key>: <value>`
  - `__meta_kubernetes_node_annotationpresent_<key>: <bool>`
  - `__meta_kubernetes_node_address_<addressType>: <address>`
- service
- pod
- endpoints
- endpointslice
