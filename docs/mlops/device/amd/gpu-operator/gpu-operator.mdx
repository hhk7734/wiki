...
[cert-manager](/docs/mlops/mlops/auth/cert-manager)가 설치되어있어야 합니다.
...
device plugin 들이 [Node feature Discovery](/docs/mlops/device/node-feature-discovery)를 사용하는 경우가 많기 때문에 따로 설정해서 설치하는 것을 권장합니다.
