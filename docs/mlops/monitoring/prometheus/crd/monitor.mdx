...
[kubernetes_sd_configs](#kubernetes_sd_configs) `role: endpoints`가 자동으로 추가됩니다.
...
- https://github.com/prometheus-operator/prometheus-operator/blob/main/Documentation/api.md#scrapeconfig
