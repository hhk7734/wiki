...
sidebar_label: Training Parallelism
...
<center>
	<img src={useBaseUrl("img/mlops/nn/llm/bubble.png")} />
	<figcaption>
...
<center>
	<img className="bg-white" src={useBaseUrl("img/mlops/nn/llm/3d-parallelism-1.png")} />
	<figcaption>
	...
	<img className="bg-white" src={useBaseUrl("img/mlops/nn/llm/3d-parallelism-2.png")} />
	<figcaption>
