...
- [Argo Workflows entrypoint and templates](/docs/mlops/argo-workflows/entrypoint-templates.mdx)

### Variables

- [Argo Workflows Variables](/docs/mlops/argo-workflows/variables.mdx)

### `podGC`

- [podGC](/docs/mlops/argo-workflows/garbage-collection.mdx#podgc)

### `ttlStrategy`

- [ttlStrategy](/docs/mlops/argo-workflows/garbage-collection.mdx#ttlstrategy)
