...
- [`resource` -> `outputs.parameters`](/docs/mlops/argo-workflows/variables.mdx#resource---outputsparameters)
...
- [Argo Workflows DAG template](/docs/mlops/argo-workflows/dag.mdx)
