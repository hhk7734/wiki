...
- `serviceAllocation`
  ...
  - `namespaces: []`
  - `namespaceSelectors: []`
    - [LabelSelector](/docs/mlops/kubernetes/labels.mdx#label-selector)
  - `serviceSelectors: []`
    - [LabelSelector](/docs/mlops/kubernetes/labels.mdx#label-selector)
...
- `spec`
  - `externalTrafficPolicy: Cluster`
    ...
    - BGP + `Local` + [affinity](/docs/mlops/kubernetes/scheduling/affinity.mdx) 설정으로 최적의 트래픽 흐름을 만들 수 있습니다.
