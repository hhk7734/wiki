...
- [L2Advertisement](/docs/mlops/network/metallb/arp.mdx)
- [BGPAdvertisement](/docs/mlops/network/metallb/bgp.mdx)
...
- `spec`
  - `externalTrafficPolicy: Cluster`
    - [Service # externalTrafficPolicy](/docs/mlops/kubernetes/network/service.mdx#externaltrafficpolicy)
