...
- `serviceAllocation`
  ...
  - `namespaces: []`
  - `namespaceSelectors: []`
    - [LabelSelector](/docs/infrastructure/kubernetes/kubernetes/labels.mdx#label-selector)
  - `serviceSelectors: []`
    - [LabelSelector](/docs/infrastructure/kubernetes/kubernetes/labels.mdx#label-selector)
...
- [BGPAdvertisement](/docs/infrastructure/networking/metallb/bgp.mdx)
...
- `spec`
  - `externalTrafficPolicy: Cluster`
    - [Service # externalTrafficPolicy](/docs/infrastructure/kubernetes/kubernetes/service.mdx#externaltrafficpolicy)
    - BGP + `Local` + [affinity](/docs/infrastructure/kubernetes/kubernetes/scheduling/affinity.mdx) 설정으로 최적의 트래픽 흐름을 만들 수 있습니다.
