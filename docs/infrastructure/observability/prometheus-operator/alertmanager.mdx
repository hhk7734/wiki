...
Alertmanager CR을 생성하고 Service를 확인(또는 생성)한 후, 이를 사용할 [Prometheus에 관련 정보를 설정](/docs/infrastructure/observability/prometheus-operator/prometheus.mdx#alertmanager-연결하기)합니다.
