...
```shell
mkdir -p storage/aws-ebs-csi-driver/base
```
...
helm show values aws-ebs-csi-driver/aws-ebs-csi-driver \
    --version 2.6.2 \
    > storage/aws-ebs-csi-driver/base/values.yaml
```

```yaml title="storage/aws-ebs-csi-driver/base/values.yaml"
controller:
  serviceAccount:
    create: true
...
helm upgrade aws-ebs-csi-driver aws-ebs-csi-driver/aws-ebs-csi-driver \
    ...
    -n kube-system \
    --create-namespace \
    -f storage/aws-ebs-csi-driver/base/values.yaml
```
