...
- https://karpenter.sh/v0.9.0/provisioner/
...
- https://karpenter.sh/v0.9.0/aws/provisioning/
...
- https://karpenter.sh/v0.9.0/getting-started/getting-started-with-terraform/
