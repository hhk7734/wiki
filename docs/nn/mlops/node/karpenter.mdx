...
- https://karpenter.sh/v0.12.1/provisioner/
...
- https://karpenter.sh/v0.12.1/aws/provisioning/
...
- https://karpenter.sh/v0.12.1/getting-started/getting-started-with-terraform/
