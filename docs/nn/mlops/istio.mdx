...
&& sudo mv istio-1.9.5/ /opt/
```

```shell
export PATH=/opt/istio-1.9.5/bin:$PATH
```

```yaml title="istio-cr.yaml"
...
```shell
istioctl install -f istio-cr.yaml
```
...
- [https://github.com/istio/istio/blob/master/samples/addons/kiali.yaml](https://github.com/istio/istio/blob/master/samples/addons/kiali.yaml)
...
- [https://istio.io/latest/docs/setup/install/](https://istio.io/latest/docs/setup/install/)
