...
```shell
mkdir -p prometheus-operator/prometheus-operator/base
```
...
helm show values prometheus-community/kube-prometheus-stack \
    --version 20.0.1 \
    > prometheus-operator/prometheus-operator/base/values.yaml
```

```yaml title="prometheus-operator/prometheus-operator/base/values.yaml"
# ...
...
helm upgrade prometheus-operator prometheus-community/kube-prometheus-stack \
    ...
    -n monitoring \
    --create-namespace \
    -f prometheus-operator/prometheus-operator/base/values.yaml
```

```shell
helm get manifest -n monitoring prometheus-operator \
    > prometheus-operator/prometheus-operator/base/prometheus-operator.yaml
```
