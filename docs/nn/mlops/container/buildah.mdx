...
```shell
skopeo copy containers-storage:localhost/ping:latest docker://<account>.dkr.ecr.<region>.amazonaws.com/<image>
```

## inspect

```shell
skopeo inspect docker://<account>.dkr.ecr.<region>.amazonaws.com/<image>:<tag>
```
