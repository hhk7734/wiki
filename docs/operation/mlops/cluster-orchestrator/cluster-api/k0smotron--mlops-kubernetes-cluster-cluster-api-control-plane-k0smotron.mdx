---
id: k0smotron--mlops-kubernetes-cluster-cluster-api-control-plane-k0smotron
...
ontology:
  ...
  aspect: k0smotron--mlops-kubernetes-cluster-cluster-api-control-plane-k0smotron
---
...
- `k0sConfig`
  ...
  - `kind: ClusterConfig`
  - `spec`
    - [k0s # Controller](/docs/operation/mlops/cluster-orchestrator/k0s/install.mdx#controller)
    - `network`
