...
- [KubeVirt 설치 가이드](/docs/operation/mlops/provisioning-tool/kubevirt/install.mdx)
...
- `template`
  - `spec`
    - `virtualMachineTemplate`
      - [KubeVirt로 VirtualMachine 생성하기](/docs/entity/mlops/provisioning-tool/virtualmachine/virtualmachine.mdx)
