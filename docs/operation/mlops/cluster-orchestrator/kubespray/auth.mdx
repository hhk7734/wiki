...
[HA / 사용자 정의 네트워크](/docs/operation/mlops/cluster-orchestrator/kubespray/ha.mdx#사용자-정의-네트워크)
...
클라이언트 설정은 [Kubernetes 인증(Authn)](/docs/entity/mlops/auth-system/authn/authn.mdx)을 참고하세요.
