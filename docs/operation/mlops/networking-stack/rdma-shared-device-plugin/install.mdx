...
:::info
[RDMA Shared Device Plugin 개요](/docs/entity/mlops/networking-stack/rdma-shared-device-plugin/rdma-shared-device-plugin.mdx) 문서에서 플러그인 역할과 설정 예시를 먼저 확인할 수 있습니다.
:::
