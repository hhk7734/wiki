...
:::warning
`predictor.affinity`, `predictor.tolerations` 등의 설정은 [Knative Serving](/docs/entity/mlops/provisioning-tool/knative/knative.mdx#knativeserving)의 설정에서 이를 허용해야 사용할 수 있습니다.
:::
