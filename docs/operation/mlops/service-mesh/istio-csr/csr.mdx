...
- [cert-manager](/docs/entity/mlops/auth-system/cert-manager/cert-manager.mdx) 설치가 선행되어야 합니다.
...
- [openssl 명령어로 Root CA 만들기](/docs/operation/mlops/auth-system/tls/x509.mdx#root-ca)
