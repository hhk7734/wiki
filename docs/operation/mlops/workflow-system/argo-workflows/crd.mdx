...
- [Argo Workflows entrypoint and templates](/docs/operation/mlops/workflow-system/argo-workflows/entrypoint-templates.mdx)

### Variables

- [Argo Workflows Variables](/docs/operation/mlops/workflow-system/argo-workflows/variables.mdx)

### `podGC`

- [podGC](/docs/operation/mlops/workflow-system/argo-workflows/garbage-collection.mdx#podgc)

### `ttlStrategy`

- [ttlStrategy](/docs/operation/mlops/workflow-system/argo-workflows/garbage-collection.mdx#ttlstrategy)
