...
- [`resource` -> `outputs.parameters`](/docs/operation/mlops/workflow-system/argo-workflows/variables.mdx#resource---outputsparameters)
...
- [Argo Workflows DAG template](/docs/operation/mlops/workflow-system/argo-workflows/dag.mdx)
