---
id: upload-executable-file-in-atmel-studio-7
...
ontology:
  ...
  domain: hardware
  class: mcu-family
  instance: avr-upload-executable-file-in-atmel-studio-7
...
Arguments는 상황에 따라 선택해줘야 합니다. [AVR upload executable file in Terminal #Upload](/docs/operation/hardware/mcu-family/avr-upload-executable-file-in-terminal/upload-executable-file-in-terminal.mdx#upload)를 참고하시기 바랍니다.
