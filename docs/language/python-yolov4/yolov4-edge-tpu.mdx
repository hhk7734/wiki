...
Ref: [https://wiki.loliot.net/docs/operation/language/library/python-yolov4/yolov4-training#full-script](https://wiki.loliot.net/docs/operation/language/library/python-yolov4/yolov4-training#full-script)
