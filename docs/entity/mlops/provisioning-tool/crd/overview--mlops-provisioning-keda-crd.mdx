---
id: overview--mlops-provisioning-keda-crd
title: "KEDA CRD 가이드"
...
ontology:
  ...
  instance: crd
  aspect: overview--mlops-provisioning-keda-crd
---
...
처리가 오래걸리는 작업에 대해, 스케일 다운이 발생하면, 처리가 완료되지 않은 작업이 중단될 수 있습니다. 이 경우 [terminationGracePeriodSeconds](/docs/operation/mlops/workload/pod-lifecycle/pod-lifecycle.mdx#termination)를 사용하거나, `ScaledJob`를 활용하는 방향으로 변경해야합니다.
...
- `spec`
  ...
  - `advanced`
    ...
    - `horizontalPodAutoscalerConfig`
      - KEDA에 의해 생성될 [HorizontalPodAutoscaler](/docs/operation/mlops/workload/horizontalpodautoscaler/horizontalpodautoscaler.mdx)의 설정입니다.
