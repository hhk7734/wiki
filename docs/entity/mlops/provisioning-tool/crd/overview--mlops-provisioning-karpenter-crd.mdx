---
id: overview--mlops-provisioning-karpenter-crd
title: "Karpenter CRD"
sidebar_label: CRD
...
ontology:
  ...
  instance: crd
  aspect: overview--mlops-provisioning-karpenter-crd
---
...
- `key`, `values`
  - [Well-Knwon Label](/docs/entity/mlops/provisioning-tool/scheduling/scheduling.mdx#well-knwon-labels)
- `operator`
  - `In`
  - `NotIn`
  - `Exists`
