---
id: overview--mlops-network-cilium-load-balancer
...
ontology:
  ...
  aspect: overview--mlops-network-cilium-load-balancer
---
...
[ARP/NDP](/docs/entity/mlops/networking-stack/arp/overview--mlops-network-cilium-arp.mdx) 설정이 활성화되어 있어야 합니다.
...
[BGP](/docs/entity/mlops/networking-stack/bgp/overview--mlops-network-cilium-bgp.mdx) 설정이 활성화되어 있어야 합니다.
