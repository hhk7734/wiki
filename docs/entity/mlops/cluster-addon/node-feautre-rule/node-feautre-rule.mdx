...
- `rules: []`
  ...
  - `taints`
    ...
    - [NFD 설치 가이드](/docs/entity/mlops/cluster-addon/node-feature-discovery/node-feature-discovery.mdx)의 `master.enableTaints`가 `true`로 설정된 경우에만 동작합니다.
  - `extendedResources`
  - `vars`
