...
- [x] Train tiny-relu with coco 2017 dataset
- [ ] Update Docs
...
<center>
  <img
    src={useBaseUrl("img/lang/python/libraries/yolov4/yolov4-performance.png")}
  />
</center>
...
<center>
  <img
    src={useBaseUrl(
      "img/lang/python/libraries/yolov4/yolov4-performance-tiny.png"
    )}
  />
</center>
