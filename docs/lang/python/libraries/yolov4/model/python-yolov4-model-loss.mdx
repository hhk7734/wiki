...
&-  \lambda_{obj}
    ...
    1^{obj}_{ij}
    \left[
        IOU^{truth}_{pred} \log \hat{C}_{ij}
        + \left( 1 - IOU^{truth}_{pred} \right)
...
- YOLOv3: An Incremental Improvement p.2
- YOLOv4: Optimal Speed and Accuracy of Object Detection p.7
