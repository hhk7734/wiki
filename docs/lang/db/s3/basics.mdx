...
| 클래스               | PUT, COPY, POST, LIST | GET, SELECT, 기타 | 수명 주기 전환 | 데이터 검색 요청 | 데이터 검색(GB 당) |
| -------------------- | :-------------------: | :---------------: | :------------: | :--------------: | :----------------: |
| Standard             |          $ 5          |       $ 0.4       |       -        |        -         |         -          |
...
|                               | IOPS       | 3000 IOPS 까지 무료, `$ 0.005 / IOPS / 월`                                                                             |
|                               | Throughput | 125 MB/s 까지 무료, `$ 0.04 / MP/s / 월`                                                                               |
| gp2                           | Storage    | `$ 0.10 / GB / 월`                                                                                                     |
| Provisioned IOPS SSD(io2)     | Storage    | `$ 0.125 / GB / 월`                                                                                                    |
|                               | IOPS       | 0 ~ 32,000 IOPS , `$ 0.065 / IOPS / 월`<br/>32,001 ~ 64,000, `$ 0.046 / IOPS / 월`<br/>64,001 ~, `$ 0.032 / IOPS / 월` |
| io1                           | Storage    | `$ 0.125 / GB / 월`                                                                                                    |
|                               | IOPS       | `$ 0.065 / IOPS / 월`                                                                                                  |
| Throughput Optimized HDD(st1) | Storage    | `$ 0.045 / GB / 월`                                                                                                    |
| Cold HDD(sc1)                 | Storage    | `$ 0.015 / GB / 월`                                                                                                    |
| 스냅샷                        |            | `$ 0.05 / GB / 월`, 증분식으로 저장됨                                                                                  |
